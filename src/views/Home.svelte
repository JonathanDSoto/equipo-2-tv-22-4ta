...
<svelte:head>
    ...
    <link rel="stylesheet" href="http://localhost:8080/libs/nouislider/nouislider.min.css">

    <!-- gridjs css -->
    <link rel="stylesheet" href="http://localhost:8080/libs/gridjs/theme/mermaid.min.css">
    ...
    <!-- ============================================ -->
       ...
       <script src="http://localhost:8080/js/pages/ecommerce-product-list.init.js"></script>
                                    ...
                                    <div class="card-header border-0">
                                        <div class="row g-4">
                                            <div class="col-sm-auto">
                                                <div>
                                                    <a href="apps-ecommerce-add-product.html" class="btn btn-success" id="addproduct-btn"><i class="ri-add-line align-bottom me-1"></i> Añadir Productos</a>
                                                </div>
                                            </div>
                                            <div class="col-sm">
                                                <div class="d-flex justify-content-sm-end">
                                                    <div class="search-box ms-2">
                                                        <input type="text" class="form-control" id="searchProductList" placeholder="Buscar Productos...">
                                                ...
                                                <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link fw-semibold" data-bs-toggle="tab" href="#productnav-published" role="tab">
                                                            Publicado <span class="badge badge-soft-danger align-middle rounded-pill ms-1">5</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                            ...
                                            <div class="col-auto">
                                                <div id="selection-element">
                                                    <div class="my-n1 d-flex align-items-center text-muted">
                                                        Seleccionar <div id="select-content" class="text-body fw-semibold px-1"></div> Resultados <button type="button" class="btn btn-link link-danger p-0 ms-3 shadow-none" data-bs-toggle="modal" data-bs-target="#removeItemModal">Eliminar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-content text-muted">
                                            ...
                                            <div class="tab-pane" id="productnav-draft" role="tabpanel">
                                                <div class="py-4 text-center">
                                                    ...
                                                    <h5 class="mt-4">Lo sentimos! No se encontraron resultados</h5>
                                                </div>
                                            </div>
                                            <!-- end tab pane -->
                                        </div>
                                                ...
                                                <div class="modal-body">
                                                    <div class="mt-2 text-center">
                                                        ...
                                                        <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                                            <h4>Estás seguro ?</h4>
                                                            <p class="text-muted mx-4 mb-0">Estás seguro de querer eliminar este producto ?</p>
                                                        </div>
                                                    </div>
