            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img id="header-lang-img" src="http://localhost:8080/images/flags/us.svg" alt="Header Language" height="20" class="rounded">
                    </button>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                        ...
                        <div class="p-2">
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="http://localhost:8080/images/brands/github.png" alt="Github">
                                        <span>GitHub</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="http://localhost:8080/images/brands/bitbucket.png" alt="bitbucket">
                                        <span>Bitbucket</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="http://localhost:8080/images/brands/dribbble.png" alt="dribbble">
                                        <span>Dribbble</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="http://localhost:8080/images/brands/dropbox.png" alt="dropbox">
                                        <span>Dropbox</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="http://localhost:8080/images/brands/mail_chimp.png" alt="mail_chimp">
                                        <span>Mail Chimp</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="http://localhost:8080/images/brands/slack.png" alt="slack">
                                        <span>Slack</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="http://localhost:8080/images/products/img-1.png" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="http://localhost:8080/images/products/img-2.png" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="http://localhost:8080/images/products/img-3.png" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="http://localhost:8080/images/products/img-6.png" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="http://localhost:8080/images/products/img-5.png" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                        ...
                        <div class="tab-content" id="notificationItemsTabContent">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative active">
                                        <div class="d-flex">
                                            <img src="http://localhost:8080/images/users/avatar-2.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            <img src="http://localhost:8080/images/users/avatar-8.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                            ...
                            <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel" aria-labelledby="messages-tab">
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    <div class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            <img src="http://localhost:8080/images/users/avatar-3.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            <img src="http://localhost:8080/images/users/avatar-6.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                            ...
                            <div class="tab-pane fade p-4" id="alerts-tab" role="tabpanel" aria-labelledby="alerts-tab">
                                <div class="w-25 w-sm-50 pt-3 mx-auto">
                                    <img src="http://localhost:8080/images/svg/bell.svg" class="img-fluid" alt="user-pic">
                                </div>
                                                        ...
                                                        <div>
                                                            <div class="d-flex align-items-center py-3">
                                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                                    <img src="http://localhost:8080/images/users/avatar-3.jpg" alt="" class="img-fluid rounded-circle shadow" />
                                                                </div>
                                                                <div class="flex-grow-1">
                                                                    <div>
                                                            ...
                                                            <div class="d-flex align-items-center py-3">
                                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                                    <img src="http://localhost:8080/images/users/avatar-4.jpg" alt="" class="img-fluid rounded-circle shadow" />
                                                                </div>
                                                                <div class="flex-grow-1">
                                                                    <div>
                                                            ...
                                                            <div class="d-flex align-items-center py-3">
                                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                                    <img src="http://localhost:8080/images/users/avatar-5.jpg" alt="" class="img-fluid rounded-circle shadow" />
                                                                </div>
                                                                <div class="flex-grow-1">
                                                                    <div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="d-flex mb-4">
                                                            <div class="flex-shrink-0">
                                                                <img src="http://localhost:8080/images/small/img-4.jpg" alt="" height="50" class="rounded shadow" />
                                                            </div>
                                                        ...
                                                        <div class="d-flex mb-4">
                                                            <div class="flex-shrink-0">
                                                                <img src="http://localhost:8080/images/small/img-5.jpg" alt="" height="50" class="rounded shadow" />
                                                            </div>
                                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                                <a href="javascript:void(0);">
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="flex-shrink-0">
                                                                <img src="http://localhost:8080/images/small/img-6.jpg" alt="" height="50" class="rounded shadow" />
                                                            </div>
                                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                                <a href="javascript:void(0);">
                                                                                ...
                                                                                <div class="accordion-item border-0">
                                                                                    <div class="accordion-header" id="headingOne">
                                                                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseOne" aria-expanded="true">
                                                                                            <div class="d-flex">
                                                                                                <div class="flex-shrink-0">
                                                                                                    <img src="http://localhost:8080/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                                                                                </div>
                                                                                ...
                                                                                <div class="accordion-item border-0">
                                                                                    <div class="accordion-header" id="headingThree">
                                                                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapsethree" aria-expanded="false">
                                                                                            <div class="d-flex">
                                                                                                <div class="flex-shrink-0">
                                                                                                    <img src="http://localhost:8080/images/users/avatar-5.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                                                                                </div>
                                                                                                <div class="flex-grow-1 ms-3">
                                                                                ...
                                                                                <div class="accordion-item border-0">
                                                                                    <div class="accordion-header" id="headingFive">
                                                                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseFive" aria-expanded="true">
                                                                                            <div class="d-flex">
                                                                                                <div class="flex-shrink-0">
                                                                                                    <img src="http://localhost:8080/images/users/avatar-7.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                                                                                </div>
                                                                                                <div class="flex-grow-1 ms-3">
                                                                                                    <h6 class="fs-14 mb-1">
                                                                                                        Lewis Arnold
                                                                                        ...
                                                                                        <div class="accordion-body ms-2 ps-5">
                                                                                            ...
                                                                                            <div class="avatar-group">
                                                                                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Christi">
                                                                                                    <img src="http://localhost:8080/images/users/avatar-4.jpg" alt="" class="rounded-circle avatar-xs">
                                                                                                </a>
                                                                                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Frank Hook">
                                                                                                    <img src="http://localhost:8080/images/users/avatar-3.jpg" alt="" class="rounded-circle avatar-xs">
                                                                                                </a>
                                                                                ...
                                                                                <div class="accordion-item border-0">
                                                                                    <div class="accordion-header" id="heading6">
                                                                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapse6" aria-expanded="true">
                                                                                            <div class="d-flex">
                                                                                                <div class="flex-shrink-0">
                                                                                                    <img src="http://localhost:8080/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                                                                                </div>
                                                                                                <div class="flex-grow-1 ms-3">
                                                                                                    <h6 class="fs-14 mb-1">
                                                                                                        Joseph Parker
                                                                                            ...
                                                                                            <div class="row mt-2">
                                                                                                <div class="col-xxl-6">
                                                                                                    <div class="row border border-dashed gx-2 p-2 shadow">
                                                                                                        <div class="col-3">
                                                                                                            <img src="http://localhost:8080/images/small/img-3.jpg" alt="" class="img-fluid rounded shadow" />
                                                                                                        </div>
                                                                                                        <!--end col-->
                                                                                                        <div class="col-3">
                                                                                                            <img src="http://localhost:8080/images/small/img-5.jpg" alt="" class="img-fluid rounded shadow" />
                                                                                                        </div>
                                                                                                        <!--end col-->
                                                                                                        <div class="col-3">
                                                                                                            <img src="http://localhost:8080/images/small/img-7.jpg" alt="" class="img-fluid rounded shadow" />
                                                                                                        </div>
                                                                                                        <!--end col-->
                                                                                                        <div class="col-3">
                                                                                                            <img src="http://localhost:8080/images/small/img-9.jpg" alt="" class="img-fluid rounded shadow" />
                                                                                                        </div>
                                                                                                        <!--end col-->
                                                                                                    </div>
                                                                                                    <!--end row-->
                                                                                ...
                                                                                <div class="accordion-item border-0">
                                                                                    <div class="accordion-header" id="heading9">
                                                                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapse9" aria-expanded="false">
                                                                                            <div class="d-flex">
                                                                                                <div class="flex-shrink-0">
                                                                                                    <img src="http://localhost:8080/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                                                                                </div>
                                                                                                <div class="flex-grow-1 ms-3">
                                                                                                    <h6 class="fs-14 mb-1">
                                                                                    ...
                                                                                    <div class="d-flex align-items-center gap-2">
                                                                                        ...
                                                                                        <div class="avatar-group">
                                                                                            <div class="avatar-group-item shadow">
                                                                                                <div class="avatar-xs">
                                                                                                    <img src="http://localhost:8080/images/users/avatar-4.jpg" alt="" class="rounded-circle img-fluid" />
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="avatar-group-item shadow">
                                                                                                <div class="avatar-xs">
                                                                                                    <img src="http://localhost:8080/images/users/avatar-5.jpg" alt="" class="rounded-circle img-fluid" />
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="avatar-group-item shadow">
                                                                                                <div class="avatar-xs">
                                                                                            ...
                                                                                            <div class="avatar-group-item shadow">
                                                                                                <div class="avatar-xs">
                                                                                                    <img src="http://localhost:8080/images/users/avatar-2.jpg" alt="" class="rounded-circle img-fluid" />
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="acitivity-timeline">
                                                    <div class="acitivity-item d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src="http://localhost:8080/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src="http://localhost:8080/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xxl-4">
                                                                    <div class="row border border-dashed gx-2 p-2 mb-2">
                                                                        <div class="col-4">
                                                                            <img src="http://localhost:8080/images/small/img-2.jpg" alt="" class="img-fluid rounded shadow" />
                                                                        </div>
                                                                        <!--end col-->
                                                                        <div class="col-4">
                                                                            <img src="http://localhost:8080/images/small/img-3.jpg" alt="" class="img-fluid rounded shadow" />
                                                                        ...
                                                                        <!--end col-->
                                                                        <div class="col-4">
                                                                            <img src="http://localhost:8080/images/small/img-4.jpg" alt="" class="img-fluid rounded shadow" />
                                                                        </div>
                                                                        <!--end col-->
                                                                    </div>
                                                                    <!--end row-->
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src="http://localhost:8080/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src="http://localhost:8080/images/users/avatar-7.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="acitivity-item d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src="http://localhost:8080/images/users/avatar-8.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        <div class="d-flex align-items-center gap-2">
                                                                            ...
                                                                            <div class="avatar-group">
                                                                                <div class="avatar-group-item shadow">
                                                                                    <div class="avatar-xs">
                                                                                        <img src="http://localhost:8080/images/users/avatar-1.jpg" alt="" class="rounded-circle img-fluid" />
                                                                                    </div>
                                                                                </div>
                                                                                <div class="avatar-group-item shadow">
                                                                                    <div class="avatar-xs">
                                                                                        <img src="http://localhost:8080/images/users/avatar-3.jpg" alt="" class="rounded-circle img-fluid" />
                                                                                    </div>
                                                                                </div>
                                                                                <div class="avatar-group-item shadow">
                                                                                    <div class="avatar-xs">
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        <div class="d-flex align-items-center gap-2">
                                                                            ...
                                                                            <div class="avatar-group">
                                                                                <div class="avatar-group-item shadow">
                                                                                    <div class="avatar-xs">
                                                                                        <img src="http://localhost:8080/images/users/avatar-8.jpg" alt="" class="rounded-circle img-fluid" />
                                                                                    </div>
                                                                                </div>
                                                                                <div class="avatar-group-item shadow">
                                                                                    <div class="avatar-xs">
                                                                                        <img src="http://localhost:8080/images/users/avatar-7.jpg" alt="" class="rounded-circle img-fluid" />
                                                                                    </div>
                                                                                </div>
                                                                                <div class="avatar-group-item shadow">
                                                                                    <div class="avatar-xs">
                                                                                        <img src="http://localhost:8080/images/users/avatar-6.jpg" alt="" class="rounded-circle img-fluid" />
                                                                                    </div>
                                                                                </div>
                                                                                <div class="avatar-group-item shadow">
                                                                                    <div class="avatar-xs">
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="http://localhost:8080/images/sidebar/img-1.jpg" alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>	
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="http://localhost:8080/images/sidebar/img-2.jpg" alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-03" value="img-3">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="http://localhost:8080/images/sidebar/img-3.jpg" alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-04" value="img-4">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="http://localhost:8080/images/sidebar/img-4.jpg" alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                        </div>
                    </div>
