                ...
                <!-- end page title -->
                    ...
                    <div class="profile-foreground position-relative mx-n4 mt-n4">
                        <div class="profile-wid-bg">
                            <img src={infoUserLogged.avatar} alt={infoUserLogged.name & infoUserLogged.lastname} class="profile-wid-img" />
                        </div>
                    </div>
                    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
                        <div class="row g-4">
                            <div class="col-auto">
                                <div class="avatar-lg">
                                    <img src={infoUserLogged.avatar} class="img-thumbnail rounded-circle" />
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col">
                                <div class="p-2">
                                    <h3 class="text-white mb-1">{infoUserLogged.name} {infoUserLogged.lastname}</h3>
                                                            ...
                                                            <table class="table table-borderless mb-0">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-muted">{infoUserLogged.name}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Apellido :</th>
                                                                        <td class="text-muted">{infoUserLogged.lastname}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Correo:</th>
                                                                        <td class="text-muted">{infoUserLogged.email}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Teléfono :</th>
                                                                        <td class="text-muted">{infoUserLogged?.phone_number ?? ''}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Rol:</th>
                                                                        <td class="text-muted">{infoUserLogged.role}</td>
                                                                    </tr>                                                                   
                                                                </tbody>
                                                            </table>
                                                        </div>
