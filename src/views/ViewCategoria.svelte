                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Vista de Detalle Categoría</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="#!">Catalogos</a></li>
                                            <li class="breadcrumb-item active">Vista Detalle Catálogos</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Categoría Especifica </h5>
                                    </div>
                                    <div class="card-body">
