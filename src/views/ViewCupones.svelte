                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="#!">Cupones</a></li>
                                            <li class="breadcrumb-item active">Vista de Detalle Cupón</li>
                                        </ol>
                                    </div>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-borderless mb-0">
                                                                        <tbody>
                                                                            <tr>
                                                                                <th class="ps-0" scope="row">Nombre del cupón:</th>
                                                                                <td class="text-muted">Cupón 1</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <th class="ps-0" scope="row">Código:</th>
                                                                                <td class="text-muted">X-2345</td>
                                                                            </tr>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <th class="ps-0" scope="row">Porcentaje de descuento del cupón:</th>
                                                                            ...
                                                                            <tr>
                                                                                <th class="ps-0" scope="row">Máximo de usos:</th>
                                                                                <td class="text-muted">100</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <th class="ps-0" scope="row">Mínimo de monto solicitado:</th>
                                                                                <td class="text-muted">100</td>

                                                                            </tr>
                                                                            <tr>
                                                                                <th class="ps-0" scope="row">Mínimo de producto solicitado:</th>
                                                                                <td class="text-muted">1</td>
                                                                            </tr>

                                                                            <tr>
                                                                                <th class="ps-0" scope="row">Fecha de inicio del cupón:</th>
                                                                                <td class="text-muted">01/10/2022</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <th class="ps-0" scope="row">Fecha de caducidad del cupón:</th>
                                                                                <td class="text-muted">01/11/2022</td>
                                                                            </tr>
                                                                            <tr>
                                                                ...
                                                                <div class="col-xl-3 col-md-6 pd-3">
                                                                   <h5 class="card-title mb-0 pt-3">Widget Gráfico de Descuento Total y Porcentaje </h5>
                                                                    <div class="card card-animate bg-primary">
                                                                        <div class="card-body">
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="flex-grow-1">
                                                                                    <p class="text-uppercase fw-medium text-white-50 mb-0">Monto descontado total</p>
                                                                                </div>
                                                                                <div class="flex-shrink-0">
                                                                                    <h5 class="text-warning fs-14 mb-0">
                                                                                        <i class="ri-arrow-right-down-line fs-13 align-middle"></i> -50%
                                                                                    </h5>
                                                                                </div>
                                                                            </div>
                                                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                                                <div>
                                                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4 text-white">$<span class="counter-value" data-target="1000">0</span></h4>
