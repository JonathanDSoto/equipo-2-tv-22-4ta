...
<svelte:head>
    <title>DevEcommerce | Vista Detalle Etiqueta</title>
    <!-- ============================================ -->
    <!-- Css template -->
    <!-- ============================================ -->
    <!-- App favicon -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Vista de Detalle Etiqueta</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="#!">Catalogos</a></li>
                                            <li class="breadcrumb-item active">Vista Detalle Etiqueta</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Etiqueta Especifica </h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Decoración de sala</td>
                                                    <td>Todo para crear un ambiente agradable en tu sala de estar</td>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title mb-0">Lista Productos</h4>
                                    </div><!-- end card header -->
                                            ...
                                            <div class="table-responsive table-card mt-3 mb-1">
                                                <table class="table align-middle table-nowrap" id="customerTable">
                                                    ...
                                                    <tbody class="list form-check-all">
                                                        <tr>
                                                            <td class="photo">
                                                                <img class="image avatar-lg square-shadow" alt="" src="http://localhost:8080/images/users/avatar-1.jpg">
                                                            </td>

                                                            <td class="name">Lampara de luz LED</td>
                                                            <td class="description">Disfruta de una iluminación relajante con este nuevo producto de luces LED</td>
                                                            <td>
